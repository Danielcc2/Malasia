...
const categories: Category[] = [
  ...
  },
  {
    ...
    subtitle: "Masajes, termas, spas de lujo, yoga y retiros en la selva",
    experiences: [
      {
        name: "Urut Melayu — Masaje malayo tradicional",
        location: "En todo Malasia",
        description: "El masaje tradicional malayo con aceites de hierbas medicinales locales como halia (jengibre), serai (lemongrass) y kunyit (curcuma). Tecnica profunda y terapeutica que trabaja musculos y meridianos energeticos. Diferente al tailandes, mas lento y envolvente.",
        price: "40-80 MYR por hora",
        priceEur: "8.50-17 EUR",
        tip: "Evita los centros de masajes en centros comerciales. Busca los 'pusat urut' en zonas residenciales: misma calidad, mitad de precio.",
        stars: 5,
      },
      {
        name: "Aguas termales de Sungai Klah",
        location: "Sungkai, Perak",
        description: "Termas naturales en plena selva tropical con agua geotérmica a 42 C. Piscinas de diferentes temperaturas, jacuzzis naturales entre rocas y niebla del bosque al amanecer. El sitio mas relajante de la peninsula.",
        price: "25-50 MYR entrada",
        priceEur: "5-11 EUR",
        tip: "Los fines de semana estan llenos de familias. Ve entre semana por la manana temprano para tenerlo casi para ti solo con la niebla del bosque.",
        stars: 5,
      },
      {
        name: "Reflexologia de pies en Chinatown",
        location: "Petaling Street, KL",
        description: "Masaje de reflexologia de pies de origen chino en locales de Chinatown. La tecnica trabaja puntos de presion en los pies que corresponden a organos de todo el cuerpo. Duele un poco pero la sensacion posterior es increible.",
        price: "25-45 MYR por hora",
        priceEur: "5-9.50 EUR",
        tip: "Pide el masaje con piedras calientes, vale 10 MYR mas y hace una diferencia enorme. Los locales sin decoracion suelen tener los mejores masajistas.",
        stars: 4,
      },
      {
        name: "Spa de lujo en el Mandarin Oriental KL",
        location: "KLCC, Kuala Lumpur",
        description: "El spa mas lujoso de Malasia con vistas a las Torres Petronas. Tratamientos con ingredientes locales: masaje con aceite de coco virgen, wrap de cafe malayo, ritual de flores de hibisco y baño de leche de coco en bañera de marmol.",
        price: "350-800 MYR por tratamiento",
        priceEur: "74-170 EUR",
        tip: "Los lunes y martes hay descuentos del 30% para residentes y turistas. Reserva con una semana de antelacion para los tratamientos signature.",
        stars: 5,
      },
      {
        name: "Termas de Bentong Hot Springs",
        location: "Bentong, Pahang",
        description: "Aguas termales naturales a 2 horas de KL en plena selva de Pahang. Piscinas publicas a 38-42 C y bungalows privados con jacuzzi termal propio. Rodeado de jungla primaria con sonidos de pajaros y cascadas cercanas.",
        price: "15-30 MYR (publico) / 80-150 MYR (privado)",
        priceEur: "3-6 EUR / 17-32 EUR",
        tip: "Los bungalows privados con terma propia son la joya. Reserva con antelacion los fines de semana. El agua mineral del manantial es potable.",
        stars: 4,
      },
      {
        name: "Masaje tailandes en George Town",
        location: "George Town, Penang",
        description: "Penang tiene los mejores centros de masaje tailandes fuera de Tailandia, traidos por la comunidad thai que lleva generaciones en la isla. Masaje seco con tecnica de presion y estiramientos de yoga pasivo.",
        price: "45-90 MYR por hora",
        priceEur: "9.50-19 EUR",
        tip: "Dile al terapeuta tu nivel de presion preferido al principio. 'Soft', 'medium' o 'hard'. Los tailandeses tienden a ir fuerte por defecto.",
        stars: 5,
      },
      {
        name: "Yoga al amanecer en Perhentian Islands",
        location: "Islas Perhentian, Terengganu",
        description: "Clases de yoga al amanecer en la playa con el sonido de las olas y la selva. Instructores internacionales que pasan temporadas en la isla. La combinacion de yoga, mar turquesa y selva crea una experiencia de bienestar unica.",
        price: "30-60 MYR por clase",
        priceEur: "6-13 EUR",
        tip: "Las clases de las 7am tienen la mejor luz. Muchos resorts de la isla ofrecen paquetes de yoga + alojamiento muy economicos.",
        stars: 5,
      },
      {
        name: "Retiro de meditacion en los templos de Penang",
        location: "Kek Lok Si / Dharmikarama, Penang",
        description: "Los templos budistas y taoistas de Penang ofrecen sesiones de meditacion guiada abiertas a visitantes. En el templo Dhammikarama puedes practicar meditacion Vipassana con monjes birmanos en un ambiente de paz absoluta.",
        price: "Gratis (donacion voluntaria)",
        priceEur: "Gratis",
        tip: "Ve con ropa comoda y suelta. Las sesiones de meditacion suelen ser de 7-9am y 5-7pm. Sin reserva, se presentan directamente.",
        stars: 4,
      },
      {
        name: "Hammam y spa arabe en KL",
        location: "Bukit Bintang, Kuala Lumpur",
        description: "Hammam de estilo otomano en el corazon de KL con vapor, kese (exfoliacion con guante de crin), jabón de oliva marroqui y masaje de aceites. Una experiencia de purificacion completa del cuerpo en 90-120 minutos.",
        price: "180-350 MYR",
        priceEur: "38-74 EUR",
        tip: "No comas en las 2 horas previas. El ritual completo de vapor + kese + masaje es la experiencia mas completa. Los jueves hay precio especial para parejas.",
        stars: 4,
      },
      {
        name: "Floating breakfast y spa en Langkawi",
        location: "Four Seasons / Datai, Langkawi",
        description: "Los resorts de lujo de Langkawi ofrecen el famoso floating breakfast en piscina privada con vistas a la selva, seguido de tratamientos spa con ingredientes locales: wrap de pandan, masaje con aceite de ylang-ylang y bano de flores tropicales.",
        price: "400-900 MYR por paquete",
        priceEur: "85-191 EUR",
        tip: "El Datai Langkawi tiene el spa mas premiado de Asia varias veces. Aunque no te alojes, puedes reservar tratamientos day-spa con acceso a instalaciones.",
        stars: 5,
      },
      {
        name: "Masaje balinés en los spas de KL",
        location: "Kuala Lumpur",
        description: "El masaje balinés combina técnicas de acupresion, reflexologia y aromaterapia con aceites de flores de Bali. Mas suave y aromático que el malayo o tailandes. Perfecto para el estres y la tension muscular leve.",
        price: "80-150 MYR por hora",
        priceEur: "17-32 EUR",
        tip: "Los spas de la zona de Bangsar y TTDI tienen los mejores masajistas balineses entrenados en Bali. Pregunta si el terapeuta es balinés, marca la diferencia.",
        stars: 4,
      },
      {
        name: "Detox y ayurveda en Cameron Highlands",
        location: "Cameron Highlands, Pahang",
        description: "Los centros de bienestar de Cameron Highlands ofrecen retiros de 1-3 dias con alimentacion vegetariana de las propias plantaciones, masajes ayurvedicos con aceites calientes (abhyanga), yoga y meditacion a 1500m de altitud con clima fresco.",
        price: "200-500 MYR por dia (todo incluido)",
        priceEur: "42-106 EUR",
        tip: "El clima fresco de Cameron (18-25 C) hace que la recuperacion y el descanso sean mucho mas profundos que en el calor del valle. Ideal para desconectar.",
        stars: 4,
      },
      {
        name: "Thalassoterapia en Port Dickson",
        location: "Port Dickson, Negeri Sembilan",
        description: "Tratamientos de talasoterapia con agua de mar caliente, algas marinas y envolturas de barro marino en los spas de los resorts de Port Dickson. A solo 1 hora de KL, perfecto para un dia de spa con playa.",
        price: "150-300 MYR por tratamiento",
        priceEur: "32-64 EUR",
        tip: "Los paquetes de dia que incluyen almuerzo, playa y tratamiento spa son los mas economicos. Los resorts Lexis Hibiscus tienen las mejores instalaciones.",
        stars: 3,
      },
      {
        name: "Chi Spa — Masaje con bambu caliente",
        location: "Mandarin Oriental / Shangri-La, KL",
        description: "El masaje con bastones de bambu calientes es una tecnica poco comun de gran efectividad: el calor penetra profundo en los musculos mientras el bambu trabaja los nudos y contracturas con precision. Efecto descontracturante superior al masaje manual.",
        price: "200-350 MYR por hora",
        priceEur: "42-74 EUR",
        tip: "Avisa si tienes la piel sensible al calor. El masaje de bambu sobre la espalda y piernas es especialmente efectivo para quienes viajan mucho.",
        stars: 5,
      },
      {
        name: "Baño de flores tropical en Bali-style spa",
        location: "Ubud-style spas, Kuala Lumpur / Penang",
        description: "Inmersion en bañera con flores tropicales frescas de hibisco, jazmín, rosas y pétalos de orquídea en agua templada con aceites esenciales. Fotogenico y relajante, dura 30-45 min y viene incluido en la mayoria de paquetes spa.",
        price: "60-120 MYR (solo bano) / incluido en paquetes",
        priceEur: "13-25 EUR",
        tip: "Las flores frescas son mejores que las artificiales. Pregunta al reservar si usan flores frescas del dia. La luz de la tarde da el mejor ambiente.",
        stars: 4,
      },
      {
        name: "Aguas termales de Ulu Slim",
        location: "Slim River, Perak",
        description: "Termas menos conocidas que Sungai Klah pero igual de buenas y mucho menos concurridas. Agua sulfurosa caliente en medio de palmeras y selva. Los locales vienen aqui los fines de semana a relajarse.",
        price: "10-20 MYR",
        priceEur: "2-4 EUR",
        tip: "Casi sin turistas. Lleva tu propia toalla y zapatillas. El olor a azufre desaparece a los 10 minutos de estar en el agua.",
        stars: 4,
      },
      {
        name: "Masaje en la playa — Cenang Beach",
        location: "Pantai Cenang, Langkawi",
        description: "Masajistas ambulantes en la playa mas famosa de Langkawi con hamacas y parasoles. Masaje de espalda, cuello y pies directamente en la arena con el sonido del mar. Sin cita previa, servicio informal y economico.",
        price: "25-50 MYR por 45 min",
        priceEur: "5-11 EUR",
        tip: "Regatear es normal. Paga siempre al terminar, nunca antes. Los mejores masajistas tienen clientes habituales y repiten todos los dias en el mismo sitio.",
        stars: 4,
      },
      {
        name: "Retiro de yoga y meditacion en Borneo",
        location: "Kuching / Sandakan, Borneo",
        description: "Retiros de 3-7 dias en la selva de Borneo combinando yoga de manana, trekking por la selva, observacion de orangutanes y meditacion al atardecer. Una combinacion unica de bienestar y naturaleza salvaje.",
        price: "800-2000 MYR por retiro (todo incluido)",
        priceEur: "170-424 EUR",
        tip: "Los retiros de Borneo son los mas exclusivos de Asia por la combinacion de selva primaria y bienestar. Reserva con 3-4 meses de antelacion.",
        stars: 5,
      },
      {
        name: "Sauna de hierbas (mandi wap) malaya",
        location: "Centros de bienestar tradicionales, KL",
        description: "La sauna de vapor de hierbas malaya es un ritual postnatal tradicional reconvertido en terapia de bienestar. Vapor infusionado con lemongrass, hoja de pandan, galangal y jengibre. Abre los poros, desintoxica y alivia dolores musculares.",
        price: "40-80 MYR por sesion de 45 min",
        priceEur: "8.50-17 EUR",
        tip: "Busca los centros que usan hierbas frescas en vez de bolsitas secas. El vapor de hierbas frescas es mucho mas aromatico y efectivo.",
        stars: 4,
      },
      {
        name: "Floating (flotacion sensorial) en KL",
        location: "Float KL / Float Centre, Kuala Lumpur",
        description: "Flotacion en agua con alta concentracion de sal de Epsom en una cabina totalmente oscura y silenciosa. El cuerpo flota sin esfuerzo en completo silencio, produciendo un estado de relajacion profunda y descanso mental que equivale a horas de meditacion.",
        price: "120-180 MYR por sesion de 60 min",
        priceEur: "25-38 EUR",
        tip: "No tomes cafe las 3 horas previas. La primera vez puede producir ansiedad leve los primeros 15 min, es completamente normal y desaparece. La segunda sesion es transformadora.",
        stars: 5,
      },
      {
        name: "Shiatsu japones y acupuntura en Penang",
        location: "George Town, Penang",
        description: "Penang tiene una notable comunidad japonesa con practicantes de shiatsu autentico y clinicas de acupuntura tradicional china con maestros de tercera generacion. Tratamientos holisticos de alta calidad a precios muy por debajo de Europa.",
        price: "80-150 MYR por sesion",
        priceEur: "17-32 EUR",
        tip: "Busca los centros cerca de Penang Road y Love Lane. Varios maestros tienen doctorados en medicina tradicional china. La acupuntura para el jet lag es especialmente efectiva.",
        stars: 4,
      },
    ],
  },
